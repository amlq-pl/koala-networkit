...
#include <graph/PlanarGraphTools.hpp>
#include <networkit/components/ConnectedComponents.hpp>
>>>>>>> abec78d62002fac568b18147565b97b13e5e39c8
#include <vector>
...
private:
  ...
  std::vector<Side>
  markInsideOutside(const NetworKit::Graph &H,
  ...
  void applyStep9CaseB(const NetworKit::Graph &H,
                       const std::vector<NetworKit::node> &parentH,
                       NetworKit::node y, NetworKit::node &v1,
                       NetworKit::node &w1, std::vector<NetworKit::node> &cycle,
                       std::vector<Side> &side, int &insideCost);
